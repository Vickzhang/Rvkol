...
module.exports={
    ...
    'POST /submitCar':async (ctx, next) => {
        let carDetail = {
            ...
            carXuangua: ctx.request.body.carXuanGua,
            ...
            carGangticailiao: ctx.request.body.carGangticailiao,
            carGanggaicailiao: ctx.request.body.carGanggaicailiao,
        ...
        (async () => {
            var RVuser = await Car.create({
                ...
                carXuangua: carDetail.carXuangua,
                ...
                carGangticailiao: carDetail.carGangticailiao,
                carGanggaicailiao: carDetail.carGanggaicailiao,
